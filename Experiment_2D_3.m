...
%% sweep
%varying omega for 4 values of PPWx
...
for i = 25:25:200
    ...
    semilogy(OMEGA,RK4_L2_error,'ko','MarkerSize',10)
    hold on
...
for i = 25:25:200
    ...
    semilogy(OMEGA,RK4_L2_error,'bo','MarkerSize',10)
    hold on

end

PPWx = 15;          % Points per wavelength in x-direction (marching)
...
for i = 25:25:200
    ...
    semilogy(OMEGA,RK4_L2_error,'ro','MarkerSize',10)
    hold on
...
for i = 25:25:200
    ...
    semilogy(OMEGA,RK4_L2_error,'co','MarkerSize',10)
    hold on

end

omega_vals = 25*pi:25*pi:200*pi;
plot(omega_vals,1./omega_vals,'g-')     
